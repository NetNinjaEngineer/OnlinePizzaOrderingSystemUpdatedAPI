...
namespace OnlinePizzaSystemAPI.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllAsync()
        {
            ...
            foreach (var order in all)
            {
                dtoList.Add(new OrderDto
                {
                    ...
                    OptionName = order.DeliveryOptions.ToString(),
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] OrderModel dto)
        {
            if (dto == null)
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateAsync(int id, [FromBody] OrderModel dto)
        {
