...
namespace OnlinePizzaSystemAPI.Controllers
{
    ...
    public class PaymentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllAsync()
        {
            ...
            var paymentsDTO = Enumerable.Empty<PaymentDetailsDto>()
                .ToList();

            foreach (var p in all)
            {
                paymentsDTO.Add(new PaymentDetailsDto
                {
                    CustomerId = p.CustomerId,
                    Id = p.Id,
                    PaymentAmount = p.PaymentAmount,
                    PaymentMethod = p.PaymentMethod,
                    PayMethod = p.PaymentMethod.ToString(),
        ...
        public async Task<IActionResult> GetByIdAsync(int id)
        {
            ...
            var paymentDto = new PaymentDetailsDto
            {
                ...
                PayMethod = payment.PaymentMethod.ToString()
            };
